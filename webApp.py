...
dataset_url = (
    "/Users/sanjanadubey/Documents/Projects/data-science-webapp-streamlit/nyc_collision.csv"
)

st.title("Motor Vehicle Collisions in New York City")
st.markdown("This application is a Streamlit dashboard that can be used to analyze motor vehicle collitions in NYC.")
